...
local groups = {
  ...
  ["@function.bracket"] = { fg = colors.subtle_yellow, italic = true },
  ["@function.method"] = { fg = colors.subtle_yellow, italic = true },
  ...
  ["@method.import"] = { fg = colors.subtle_yellow, italic = true },
  ...
  ["@variable.declaration"] = { fg = colors.subtle_blue },
  ["@variable.import"] = { fg = colors.subtle_blue },
  ["@type.import"] = { fg = colors.subtle_blue },
  ["@module.import"] = { fg = colors.subtle_blue },
